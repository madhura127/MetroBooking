  ...
  void Board() {
     ...
     void display_path(Path p){
       ...
       // System.out.print("Path:");
        ...
        System.out.println("Total Distance: " + p.dist);
...
class getPassword//class Node to declare all nodes and links
	...
	void create(int new_passCode,int new_password){ //to create BST
	 ...
	 void search(int s) { 		//to search a passcode
...
Path:
 1 -> 3 -> 5  6 ->
Total ticket Cost for this metro is : 100
Total Distance: 10
...
Path:
 1 -> 2 -> 3 -> 4 -> 5  6 ->
Total ticket Cost for this metro is : 200
Total Distance: 14
_______________________________________________________________________________________________________
...
________________________Here is your boarding pass.__________________________________________________________
                        ...
                        Wed Jan 05 08:17:58 GMT 2022            1        2               YES
